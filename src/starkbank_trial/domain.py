...
class Receipt:
    """Payment values used to calculate the amount transferred to the destination."""
...
def _read(source: Any, *names):
    """Read the first matching field from either a dict or an SDK object."""
...
def receipt_from(invoice_id, payment, fallback=None):
    """Normalize Stark payment data into the internal Receipt model."""
